 ...
 * @author Shang
 */
public class AdminHistorySearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (txtSearch != null && !"".equals(txtSearch)) {
                listOrder = orderDAO.searchByUserID(txtSearch);
            } else if (txtDate != null && !"".equals(txtDate)) {
                listOrder = orderDAO.searchByOrderDate(txtDate);
            } else {
            ...
            log("Error at AdminHistorySearchController: " + e.getMessage());
        } finally {
